...
namespace Byn.Awrtc.Unity
{
    ...
    public class UnityCallFactory : MonoBehaviour
    {
        ...
        /// </summary>
        public static readonly bool OBSOLETE_UNITY_CAMERA = false;
        ...
        private UnityVideoCapturerFactory mVideoFactory;
        ...
        private static bool StaticInitBrowser()
        {
            ...
            if (Byn.Awrtc.Browser.BrowserCallFactory.IsAvailable() == false)
            {
                ...
                Debug.LogError(LOG_PREFIX + "java script plugin missing. Please make sure the file awrtc.jspre is included in WebGL builds!");
                return false;
                /*
        ...
        private static bool StaticInitAndroid()
        {
            ...
            try
            {
                ...
                {
                    Debug.LogError(LOG_PREFIX + "Failed to initialize android java plugin.");
                    return false;
                }
                ...
                {
                    Debug.LogError(LOG_PREFIX + "Failed to initialize android native plugin.");
                }
                successful = true;
            }
            catch (Exception e)
        ...
        public IBasicNetwork CreateBasicNetwork(string websocketUrl, IceServer[] iceServers = null)
        {
        ...
        /// <summary>
        /// Call to the native WebGL plugin to update its logging 
        /// policity.
        /// </summary>
        private void UpdateLogLevel_WebGl()
        {
            ...
            Browser.CAPI.SLog_SetLogLevel(logLevel);
#endif
        }
