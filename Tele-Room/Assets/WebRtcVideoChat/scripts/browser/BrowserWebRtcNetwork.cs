...
namespace Byn.Awrtc.Browser
{
    ...
    public class BrowserWebRtcNetwork : IWebRtcNetwork
    {
        ...
        [DllImport("__Internal")]
        private static extern bool UnityWebRtcNetworkSendData(int lIndex, int lConnectionId, byte[] lUint8ArrayDataPtr, int lUint8ArrayDataOffset, int lUint8ArrayDataLength, bool lReliable);
        ...
        {
            return UnityWebRtcNetworkSendData(mReference, conId.id, data, offset, length, reliable);
        }
